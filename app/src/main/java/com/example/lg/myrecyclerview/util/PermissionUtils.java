...
/**
 * Created by lijingru on 2017/9/18.
 */
...
public class PermissionUtils {
    ...
    //跳转到权限设置页面的code
    public static final int REQUEST_DETAILS_SETTINGS=101;
...
//        }
    ...
    public static void requestMultiResult(Activity activity, String[] permissions, int[] grantResults, PermissionGrant permissionGrant) {
        ...
        //TODO
        Log.i("requestMultiResult", "onRequestPermissionsResult permissions length:" + permissions.length);
        Map<String, Integer> perms = new HashMap<>();

        ArrayList<String> notGranted = new ArrayList<>();
        for (int i = 0; i < permissions.length; i++) {
            Log.i("requestMultiResult", "permissions: [i]: " + i + ";  permissions[i]" + permissions[i] + ";  grantResults[i]:" + grantResults[i]);
        ...
        if (notGranted.size() == 0) {
            ...
            openSettingActivity(activity, "PPMap需要存储、电话状态、定位权限，是否设置");
        }
    ...
    private static void openSettingActivity(final Activity activity, String message) {
        ...
        showMessageOKCancel(activity, message, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                intent.setData(uri);
                activity.startActivityForResult(intent,REQUEST_DETAILS_SETTINGS);
            }
        });
    }
    ...
    private static void shouldShowRationale(final Activity activity, final int requestCode, final String requestPermission) {
        ...
        Log.i("拒绝权限后的提醒：",""+permissionsHint[requestCode]);
            ...
            if (checkSelfPermission != PackageManager.PERMISSION_GRANTED) {
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(activity, requestPermission)) {
                    ...
                    if (isShouldRationale) {
                        Log.i("isShouldRationale1",isShouldRationale+":"+requestPermission);
                    ...
                    if (!isShouldRationale) {
                        Log.i("isShouldRationale2",isShouldRationale+":"+requestPermission);
                        permissions.add(requestPermission);
                    }
