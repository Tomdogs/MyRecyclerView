...
/**
 * Created by Tomdog on 2018/4/20.
 */
...
public class SMFrameCallback implements Choreographer.FrameCallback {
    ...
    public void doFrame(long frameTimeNanos) {
        ...
        Log.i(TAG,"两次绘制时间间隔value="+value+"  frameTimeNanos="+frameTimeNanos+"  currentFrameTimeNanos="+currentFrameTimeNanos+"  skipFrameCount="+skipFrameCount+"");
