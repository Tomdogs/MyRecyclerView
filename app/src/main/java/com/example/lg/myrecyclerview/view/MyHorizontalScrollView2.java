...
/**
 * Created by Tomdog on 2018/12/27.
 */
...
public class MyHorizontalScrollView2 extends ViewGroup {
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        if(event.getAction() == MotionEvent.ACTION_DOWN){
            ...
            Log.i("父容器","dispatchTouchEvent up");
        }else {
            Log.i("父容器","dispatchTouchEvent cancel");
        }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        Log.i("父容器","onInterceptTouchEvent");
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            Log.i("父容器","onInterceptTouchEvent down");
            return false;
        } else {
            Log.i("父容器","onInterceptTouchEvent move 或 up");
            return true;
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if(event.getAction() == MotionEvent.ACTION_DOWN){
            Log.i("父容器","onTouchEvent down");
        }else if(event.getAction() == MotionEvent.ACTION_MOVE){
            Log.i("父容器","onTouchEvent move ");
        }else if (event.getAction() == MotionEvent.ACTION_UP){
            Log.i("父容器","onTouchEvent up");
        }else{
            Log.i("父容器","onTouchEvent cancel");
        }
